...
def generate_documentation(source, pycco_template, outdir=None, preserve_paths=True,
    ...
    return _generate_documentation(source, code, pycco_template, outdir, preserve_paths, language)


def _generate_documentation(file_path, code, pycco_template, outdir, preserve_paths, language):
    """
    ...
    return generate_html(file_path, sections, pycco_template, preserve_paths=preserve_paths, outdir=outdir)
...
def main():
    ...
    process(sources, outdir=outdir, preserve_paths=opts.paths,
            ...
            skip=opts.skip_bad_files,theme=opts.theme)
